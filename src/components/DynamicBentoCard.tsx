        ...
        <div className="h-full w-full flex flex-col items-center justify-center text-center p-3 md:p-4">
          <div className="w-16 h-16 flex items-center justify-center p-2 rounded-2xl bg-gradient-to-br from-primary/20 to-secondary/20 mb-3">
            {content.icon === 'WhatsApp' ? (
              /* Inline WhatsApp brand mark, centered */
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M20.52 3.48A11.88 11.88 0 0012.02.12C6.16.12 1.48 4.8 1.48 10.66c0 1.87.49 3.7 1.42 5.33L.12 23.88l8.44-2.2a11.86 11.86 0 005.46 1.28h.02c5.86 0 10.54-4.68 10.54-10.54 0-2.82-1.1-5.47-3.06-7.34z" fill="currentColor" opacity="0.08" />
