    ...
    return (
        ...
        `}>
           ...
           <div className="hidden md:flex p-6 items-center gap-3 overflow-hidden whitespace-nowrap border-b border-slate-800 h-20">
                ...
                <span className={`font-display font-bold text-lg text-[#f5fcff] transition-opacity duration-200 ${isOpen ? 'opacity-100' : 'opacity-0 lg:opacity-0'}`}>
                    Admin Panel
                </span>
            </div>
            ...
            <div className="hidden md:block p-4 border-t border-slate-700">
                 {isOpen && (
                    <div className="bg-[#1e1e1e] p-3 rounded-xl border border-slate-700 flex items-center gap-3">
                         ...
                         <div className="min-w-0">
                             <div className="text-sm font-semibold text-[#f5fcff] truncate">Administrador</div>
                             <div className="text-[10px] text-slate-400 truncate">Lima, PE</div>
                         </div>
                    </div>
                 )}
            </div>
    ...
    <div className="h-20 bg-[#171717]/80 backdrop-blur-sm border-b border-slate-800 flex items-center justify-between px-6 md:px-8 z-10 sticky top-0">
        ...
        <div className="flex items-center gap-3">
             ...
             <div className="text-right hidden sm:block">
                 ...
                 <div className="text-sm font-bold text-[#f5fcff] font-mono">10:42 AM</div>
             </div>
        </div>
    </div>
);
                        ...
                        {[1,2,3,4].map(i => (
                            <div key={i} className="flex items-center gap-4 p-3 rounded-lg hover:bg-[#202020] transition-colors border border-transparent hover:border-slate-800">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-medium text-[#f5fcff] truncate">
    ...
    >
        <div className="bg-[#171717] p-6 rounded-2xl border border-slate-800 shadow-sm">
             <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                 ...
                 <div className="flex gap-2">
                     <span className="flex items-center gap-1 text-xs font-medium px-2 py-1 bg-secondary/10 text-secondary rounded">
                         <span className="w-2 h-2 rounded-full bg-secondary"/> Lima Norte
                     </span>
...
const InventoryView = () => (
    ...
    >
        {[
            { zone: 'Almacén Central', status: 'Operativo', load: 85, color: 'bg-primary-500' },
            ...
            <div key={i} className="bg-[#171717] p-6 rounded-2xl border border-slate-800 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div className="relative">
                    ...
                    <h3 className="text-lg font-bold text-[#f5fcff] mb-1">{hub.zone}</h3>
        ...
        <table className="w-full text-left text-sm">
            <thead className="bg-[#0a0a0a] border-b border-slate-800">
                <tr>
                    ...
                    <th className="px-6 py-4 font-semibold text-[#f5fcff] hidden sm:table-cell">Última Actividad</th>
                    <th className="px-6 py-4 font-semibold text-[#f5fcff] text-right">Facturación</th>
                </tr>
            </thead>
                    ...
                    <tr key={u} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group cursor-default">
                        <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="font-medium text-[#f5fcff]">Empresa Demo S.A.C.</div>
                        ...
                        <td className="px-6 py-4 text-right font-mono font-medium text-slate-300 group-hover:text-primary">
